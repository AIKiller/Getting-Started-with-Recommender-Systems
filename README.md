...
[2024年推荐系统技术全面综述](https://mp.weixin.qq.com/s/UM8O0FNFs0O-i5JYIadcCQ) ,一篇公众号的翻译内容，其综述了2017年至2024年间推荐系统（RS）的发展历程，从传统方法到深度学习和大型语言模型的先进方法，并探讨了这些技术在不同领域的实际应用和面临的挑战。其原文链接为：https://arxiv.org/abs/2407.13699
